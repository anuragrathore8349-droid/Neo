...
marketAlertSchema.index({ userId: 1, symbol: 1 });
marketAlertSchema.index({ active: 1 });
marketAlertSchema.index({ userId: 1, symbol: 1, triggered: 1 });
marketAlertSchema.index({ active: 1, triggered: 1 });
marketAlertSchema.index({ createdAt: -1 });
marketAlertSchema.index({ userId: 1, createdAt: -1 });
