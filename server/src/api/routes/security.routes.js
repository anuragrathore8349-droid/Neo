// server/src/api/routes/security.routes.js
'use strict';
...
router.get('/activity',            securityController.getActivityLog);
...
router.put('/permissions/:id',     securityController.togglePermission);   // NEW
