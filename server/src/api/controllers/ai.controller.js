...
class AIController {
  async getPricePredictions(req, res, next) {
    try {
      ...
      const predictions = await aiService.getPricePredictions(
        symbol,
        timeframe,
        horizon
      );
  ...
  async getRiskAssessment(req, res, next) {
    try {
      ...
      const assessment = await aiService.getRiskAssessment(
        assets,
        timeframe
      );
  ...
  async getStrategyRecommendations(req, res, next) {
    try {
      ...
      const recommendations = await aiService.getStrategyRecommendations(
        portfolio,
        preferences
      );
  ...
  async detectPatterns(req, res, next) {
    try {
      ...
      const detectedPatterns = await aiService.detectPatterns(
        symbol,
        timeframe,
        patterns
      );
