          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-dark-800/50 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-dark-400 text-sm mt-1">Automatically disconnect after inactivity</p>
                  </div>
                  <select
                    value={autoLock}
              ...
              <div className="bg-dark-800/50 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-dark-400 text-sm mt-1">Maximum USD amount per day</p>
                  </div>
                  <input
                    type="number"
                    value={spendingLimit}
                    onChange={e => setSpendingLimit(e.target.value)}
                    className="bg-dark-700 border border-dark-600 rounded px-2 py-1 text-white text-sm w-24"
                    min="0"
                  />
                </div>
              </div>
              ...
              <div className="bg-dark-800/50 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-medium">Whitelist Only</h4>
                    <p className="text-dark-400 text-sm mt-1">Only allow transfers to whitelisted addresses</p>
                  </div>
              ...
              <div className="bg-dark-800/50 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-dark-400 text-sm mt-1">Enable 2FA for sensitive operations</p>
                  </div>
        ...
        <div>
          <GlassCard className="p-6 bg-blue-500/10 border-blue-500/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-white text-sm mb-2">Security Tips</p>
                <ul className="text-dark-400 text-xs space-y-2">
