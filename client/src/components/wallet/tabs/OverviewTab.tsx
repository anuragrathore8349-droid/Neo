...
interface OverviewTabProps {
  ...
  onSend?:                    (to: string, amount: string, assetSymbol?: string) => Promise<void>;
}
...
const OverviewTab: React.FC<OverviewTabProps> = ({
  connectedWallets, transactions, gasPrice, isConnecting, onConnect,
  formatAddress, formatDate, refreshWalletData, currentChainId,
