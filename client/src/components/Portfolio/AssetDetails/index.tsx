...
const AssetDetails: React.FC<AssetDetailsProps> = ({ asset, transactions, onBack }) => {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-dark-400">{asset.symbol} • {asset.type.charAt(0).toUpperCase() + asset.type.slice(1)}</p>
                </div>
              </div>
            </div>
            <div className="flex space-x-2">
              <button className="btn-outline">Trade</button>
        ...
        <GlassCard className="p-6">
          ...
          <div className="mt-6">
            <button className="w-full btn-outline">View Market Data</button>
          </div>
        </GlassCard>
      </div>
        ...
        <GlassCard className="p-6">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-dark-800/50 rounded-lg p-3">
              ...
              <p className="text-lg font-medium">{formatCurrency(priceHistoryData[0].price)}</p>
            </div>
            
            <div className="bg-dark-800/50 rounded-lg p-3">
              <p className="text-dark-400 text-xs">Close</p>
              <p className="text-lg font-medium">{formatCurrency(priceHistoryData[priceHistoryData.length - 1].price)}</p>
            </div>
            
            <div className="bg-dark-800/50 rounded-lg p-3">
              <p className="text-dark-400 text-xs">High</p>
              <p className="text-lg font-medium">{formatCurrency(Math.max(...priceHistoryData.map(d => d.price)))}</p>
            </div>
            
            <div className="bg-dark-800/50 rounded-lg p-3">
              <p className="text-dark-400 text-xs">Low</p>
              <p className="text-lg font-medium">{formatCurrency(Math.min(...priceHistoryData.map(d => d.price)))}</p>
            </div>
          </div>
        </GlassCard>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        <GlassCard className="p-6">
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            <button className="btn-outline">View All Transactions</button>
          </div>
        </GlassCard>
      </div>
    </div>
