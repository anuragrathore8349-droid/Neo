  ...
  useEffect(() => {
    const fetchLearningContent = async () => {
      try {
        ...
        const [articlesRes, videosRes, glossaryRes, guidesRes] = await Promise.all([
          fetch(`${API_BASE_URL}/learning/articles?${params}`),
          fetch(`${API_BASE_URL}/learning/videos?${params}`),
          fetch(`${API_BASE_URL}/learning/glossary?${params}`),
          fetch(`${API_BASE_URL}/learning/guides?${params}`),
        ]);

        if (!articlesRes.ok || !videosRes.ok || !glossaryRes.ok || !guidesRes.ok) {
